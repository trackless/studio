...
public class Config {
    ...
    public Font getFont() {
        String name = p.getProperty("font.name", "Arial");
        int size = Integer.parseInt(p.getProperty("font.size", "18"));
    ...
    private void init() {
        ...
        if (Files.notExists(file)) {
            try {
                ...
                System.err.println("Can't create configration file " + FILENAME);
                return;
            }
        }
    ...
    private void saveServerDetails(Server server, int number) {
        ...
        p.setProperty("server." + number + ".port", String.valueOf(server.getPort()));
